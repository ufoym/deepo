...
python ../generator/generate.py ../docker/Dockerfile.pytorch-py27-cpu pytorch python==2.7
...
python ../generator/generate.py ../docker/Dockerfile.all-py27-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe caffe2 torch darknet python==2.7 onnx
python ../generator/generate.py ../docker/Dockerfile.all-py36-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe caffe2 torch darknet python==3.6 onnx
python ../generator/generate.py ../docker/Dockerfile.all-jupyter-py27-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe caffe2 torch darknet python==2.7 onnx jupyter
python ../generator/generate.py ../docker/Dockerfile.all-jupyter-py36-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe caffe2 torch darknet python==3.6 onnx jupyter
...
python ../generator/generate.py ../docker/Dockerfile.all-py27-cu90 tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe caffe2 torch darknet python==2.7 onnx --cuda-ver 9.0 --cudnn-ver 7
python ../generator/generate.py ../docker/Dockerfile.all-py36-cu90 tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe caffe2 torch darknet python==3.6 onnx --cuda-ver 9.0 --cudnn-ver 7
python ../generator/generate.py ../docker/Dockerfile.all-jupyter-py27-cu90 tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe caffe2 torch darknet python==2.7 onnx jupyter --cuda-ver 9.0 --cudnn-ver 7
python ../generator/generate.py ../docker/Dockerfile.all-jupyter-py36-cu90 tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe caffe2 torch darknet python==3.6 onnx jupyter --cuda-ver 9.0 --cudnn-ver 7
