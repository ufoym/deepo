...
python ../generator/generate.py ../docker/Dockerfile.all-py27-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe torch python==2.7 --cpu-only
python ../generator/generate.py ../docker/Dockerfile.all-py36-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe torch python==3.6 --cpu-only
python ../generator/generate.py ../docker/Dockerfile.all-py27-jupyter-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe torch python==2.7 jupyter --cpu-only
python ../generator/generate.py ../docker/Dockerfile.all-py36-jupyter-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe torch python==3.6 jupyter --cpu-only
